...
namespace HomeRoom.Tests
{
    public abstract class HomeRoomTestBase : AbpIntegratedTestBase
    {
        protected HomeRoomTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<HomeRoomApplicationModule>();
            modules.Add<HomeRoomDataModule>();
        }

        public void UsingDbContext(Action<HomeRoomDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<HomeRoomDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<HomeRoomDbContext, T> func)
        {
            T result;
